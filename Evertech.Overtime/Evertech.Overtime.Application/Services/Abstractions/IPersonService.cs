...
public interface IPersonService
{
    ...
    Task<IReadOnlyList<PersonResponseModel>> GetActiveAsync(CancellationToken cancellationToken = default);
    Task<OperationResult> UpdateAsync(UpdatePersonModel model, CancellationToken cancellationToken = default);
