...
internal sealed class MunicipalityHolidayRepository(IUnitOfWork unitOfWork) : RepositoryBase<MunicipalityHoliday>(unitOfWork), IMunicipalityHolidayRepository
{
